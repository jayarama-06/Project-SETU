            ...
            {filteredIssues.map((issue) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Row 3: Category Icon + StatusChip + EscalationChip */}
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {/* Status Chip from chips.ts */}
                    <StatusChip status={issue.status as any} size="sm" />

                    {/* Escalation Chip from chips.ts - only show if level > 0 */}
                    {issue.escalationLevel > 0 && (
                      <EscalationChip level={issue.escalationLevel as any} size="sm" />
                    )}
                  </div>
                </div>
              );
