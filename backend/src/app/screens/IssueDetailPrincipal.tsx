import { ArrowLeft, Share2, Download, Play, Pause, Shield, Info, BadgeCheck, X } from 'lucide-react';
...
export function IssueDetailPrincipal() {
  ...
  // (state and effect declared above before early returns)
    ...
    try {
      ...
      if (result.success) {
        ...
        await addAuditLogEntry({
          ...
          old_value: '__endorsed__',
          new_value: '__endorsed__',
          note: note || 'Principal endorsed this issue as urgent',
          metadata: { is_endorsement: true, ai_urgency_score: issue.ai_urgency_score },
        });
    ...
    try {
      ...
      if (result.success) {
        ...
        await addAuditLogEntry({
          issue_id: issue.id,
          actor_id: user.id,
          action_type: 'status_changed', // 'commented' not a valid DB enum value
          old_value: '__withdraw_endorsement__',
          new_value: '__withdraw_endorsement__',
  ...
  const isEndorsedByMe = issue.is_principal_endorsed;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8F9FA]">
      ...
      {/* Principal Actions - Formal Endorsement Panel */}
      <div
        className="sticky bottom-0 left-0 right-0 bg-white border-t border-[#E5E7EB]"
        ...
        {isEndorsedByMe ? (
          ...
          <div className="px-4 pt-3 pb-4">
            ...
            >
              ...
              >
                <BadgeCheck size={20} color="#166534" strokeWidth={2} />
              </div>
              <div className="flex-1 min-w-0">
                ...
                >
                  This issue has been formally escalated with your endorsement
                </p>
              </div>
            </div>

            {/* Withdraw — subtle destructive text link */}
            <button
          ...
          /* ── Not Endorsed ── Formal action panel */
          <div className="px-4 pt-3 pb-4">
            {/* Context banner */}
            <div
            ...
            >
              <Shield size={14} color="#6B7280" style={{ marginTop: '2px', flexShrink: 0 }} />
              <p
                style={{
                  fontFamily: 'Noto Sans',
                  fontSize: '12px',
              ...
              >
                Endorsing formally flags this issue as urgent and escalates it for district review.
              </p>
            </div>

            {/* Formal Endorse button */}
            <button
              ...
              style={{
                height: '52px',
                borderRadius: '10px',
                backgroundColor: isEndorsing ? '#374151' : '#0D1B2A',
                border: 'none',
                color: '#FFFFFF',
                fontFamily: 'Noto Sans',
                fontSize: '15px',
