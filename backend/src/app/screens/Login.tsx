...
const SUPABASE_URL = 'https://zdhbncdnsbdvkcyomvax.supabase.co';
const SUPABASE_ANON = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpkaGJuY2Ruc2JkdmtjeW9tdmF4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzMwNjg5MDAsImV4cCI6MjA4ODY0NDkwMH0.iSRieGwON1y5mTvNLSAaVLWjfohQ21Uzk2eA6hOSb0o';

// ── Diagnostic: raw GoTrue fetch so we can see the real error ──
