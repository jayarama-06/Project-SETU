...
- [ ] Live chat integration (replace WhatsApp)
- [ ] FAQ accordion section
- [ ] Telemetry: Track which support options users click
- [ ] Version-specific guide downloads
- [ ] Multi-language guide variants (EN/Telugu PDFs)

---

**Status**: Help/Support modal fully implemented ✅  
